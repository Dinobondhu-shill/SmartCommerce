...
const Nav = () => {
    return (
       <div className='flex sticky top-0 z-[999] bg-gradient-to-t from-[#e1c3fd] to-transparent border-purple-200 rounded-b-3xl rounded-tl-0  md:rounded-bl-0  items-center w-full  justify-between py-1.5' >
