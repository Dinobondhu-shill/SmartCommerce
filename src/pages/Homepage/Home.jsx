...
const Home = () => {
  const banners = [
    {
      image:
        "https://i.ibb.co.com/HfyQBcsh/White-Minimalist-Banner-Etsy-Shop.png",
      path: "/",
    },
    {
      image:
        "https://i.ibb.co.com/XZKkpw5X/Banner-black-friday-webshop-ecommerce-promotion.png",
      path: "/",
    },
    {
      image:
        "https://i.ibb.co.com/0pXCdtTW/Blue-Ecommerce-Online-Shopping-Linked-In-Banner.png",
      path: "/",
    },
  ];
  const banner2 = [
    {
      image:
        "https://i.ibb.co.com/spMj8G6j/Gadget-Store-Sale-E-commerce-Storefront-Banner-in-Black-and-White-Modern-Minimalist-Style.png",
      path: "/",
    },
    {
      image:
  ...
  return (
    <div>
      ...
      <div className="flex flex-col space-y-4 mb-5">
        <ComboSection />
        <Link className="bg-purple-500 w-fit text-center mx-auto text-white font-medium text-xl px-5 py-2 rounded-2xl">
          View All Combo
        </Link>
      </div>
      {/* Hyper drop */}
